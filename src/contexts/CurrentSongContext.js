...
export const CurrentSongContext = createContext({
    currentSong:JSON.parse(localStorage.getItem("currentSong"))||{id:0,title: "Warriyo - Mortals [NCS Release]", songFile: "songs/1.mp3", thumbnail: "covers/1.jpg",owner:"Jollu"},
